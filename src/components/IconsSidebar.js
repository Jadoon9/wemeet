                    ...
                    <div class="flex-grow-1 overflow-hidden">
                      ...
                      <p class="text-truncate mb-0">
                        <span class="text-danger me-2">
                          0.01%
                          <i class="ri-arrow-right-down-line align-bottom ms-1"></i>
                        </span>
                        From previous
                      </p>
                    </div>
                  ...
                  <div class="text-muted text-center">
                    <div class="row">
                        ...
                        <div>
                          ...
                          <h5 class="font-size-16 mb-0">
                            ...
                            <span class="text-success font-size-12">
                              <i class="mdi mdi-menu-up font-size-14 me-1"></i>
                              1.2 %
                            </span>
                          </h5>
                        </div>
                      ...
                      <div class="col-4 border-end">
                        <div>
                          <p class="mb-2">
                            <i class="mdi mdi-circle font-size-12 text-light me-1"></i>
                            Maintenance
                          </p>
                          <h5 class="font-size-16 mb-0">
                            $ 8,524
                      ...
                      <div class="col-4">
                        <div>
                          <p class="mb-2">
                            <i class="mdi mdi-circle font-size-12 text-danger me-1"></i>
                            Profit
                          </p>
                          <h5 class="font-size-16 mb-0">
                            $ 8,524
                  ...
                  >
                    <a href="#" class="text-body d-block">
                      <div class="d-flex py-3">
                        ...
                        <div class="flex-shrink-0 font-size-13">20 min ago</div>
                      </div>
                    </a>
                    <a href="#" class="text-body d-block">
                      <div class="d-flex py-3">
                        ...
                        <div class="flex-shrink-0 font-size-13">9:00 am</div>
                      </div>
                    </a>
                    <a href="#" class="text-body d-block">
                      <div class="d-flex py-3">
                        <div class="flex-shrink-0 me-3 align-self-center">
                          <img
                            class="rounded-circle avatar-xs"
                            alt=""
                            src="{% static 'images/users/avatar-3.jpg' %}"
                          />
                        </div>
                        <div class="flex-grow-1 overflow-hidden">
                        ...
                        <div class="flex-shrink-0 font-size-13">8:54 am</div>
                      </div>
                    </a>
                    <a href="#" class="text-body d-block">
                      <div class="d-flex py-3">
                        ...
                        <div class="flex-shrink-0 font-size-13">27-03-2020</div>
                      </div>
                    </a>
                    ...
                    <table class="table table-centered table-nowrap mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <img
                              src="{% static 'images/users/avatar-6.jpg' %}"
                              alt="user"
                              class="avatar-xs rounded-circle"
                            />
                          </td>
